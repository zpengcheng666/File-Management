package com.oaspi.common.utils.poi;
...
import com.oaspi.common.annotation.Excel.ColumnType;
import com.oaspi.common.annotation.Excel.Type;
import com.oaspi.common.annotation.Excels;
...
import com.oaspi.common.utils.file.FileTypeUtils;
import com.oaspi.common.utils.file.FileUtils;
import com.oaspi.common.utils.file.ImageUtils;
import com.oaspi.common.utils.reflect.ReflectUtils;
...
//                        }
    ...
    {
        String downloadPath = OaspiConfig.getDownloadPath() + filename;
        ...
        switch (cell.getCellType()) {
            case STRING:
                try {
                    ...
                    throw new RuntimeException("Cannot parse string to numeric value", e);
                }
            case NUMERIC:

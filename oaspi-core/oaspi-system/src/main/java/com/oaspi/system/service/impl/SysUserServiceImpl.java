...
import com.oaspi.common.utils.bean.BeanValidators;
import com.oaspi.common.utils.spring.SpringUtils;
import com.oaspi.system.domain.SysPost;
import com.oaspi.system.domain.SysUserPost;
import com.oaspi.system.domain.SysUserRole;
import com.oaspi.system.mapper.SysPostMapper;
import com.oaspi.system.mapper.SysRoleMapper;
import com.oaspi.system.mapper.SysUserMapper;
import com.oaspi.system.mapper.SysUserPostMapper;
...
public class SysUserServiceImpl implements ISysUserService
{
     ...
     */
    @Override
    public int userUpdatePwd(SysUser user)
    {
        return userMapper.userUpdatePwd(user);
    }

    @Override
    public int adminUpdatePwd(SysUser user)
    {
        return userMapper.adminUpdatePwd(user);
    }
    ...
    @Override
    public int freezeUser(Long[] userIds) {
        return userMapper.freezeUser(userIds);
    }

    @Override
    public int unFreezeUser(Long[] userIds) {
        return userMapper.unFreezeUser(userIds);
    }
